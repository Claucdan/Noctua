...
## **Multithreading**
В данном брокере могу выделить вот такие ключевые удобные к распаролеливанию действия, которые можно разнести по корутинам:
...
- **fmt + spdlog** (для быстрого логирования + вывода информации)
